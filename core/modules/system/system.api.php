 ...
 * implement this hook, but declare these files in their .info.yml file.
 *
 * @see hook_boot()
 */
function hook_init() {
 ...
 * them. The $modules array provides the .info.yml file information, which
 * includes the list of files registered to each module. Any files in the list
 ...
 *   Each element of the array also contains the module's .info.yml file
